export default {
    ...
    agent: {
        ...
        panel: { connectionSettings: "Connection settings · {{status}}", connectionSettingsLabel: "Connection settings. Current status: {{status}}", chat: "Chat", history: "History", skills: "Skills", agents: "Agents", logs: "Logs", collapse: "Collapse chat", collapseLabel: "Collapse Agent panel", resize: "Resize right panel", content: "Agent content", mcpInitializing: "MCP is initializing. You can send messages when it is ready.", initFailed: "Codex conversation initialization failed. Start or resume a conversation.", placeholder: "Ask Codex, type / for Skills, or @ to reference canvas assets" },
        collaboration: { connectedAgents: "External agents", noAgents: "No external agents connected", activity: "Recent activity", noActivity: "No collaboration activity", broadcast: "Broadcast task", titlePlaceholder: "Task title", goalPlaceholder: "Enter a task for multiple agents to handle independently", publish: "Publish", createFailed: "Failed to create broadcast task", apply: "Apply to canvas", applyFailed: "Could not apply collaboration result", status: { connected: "Connected", idle: "Idle", waiting: "Waiting", running: "Running", approval: "Approval", completed: "Completed", failed: "Failed", offline: "Offline" } },
