...
export function startHttpServer() {
    ...
    app.listen(port, "127.0.0.1", () => {
        ...
        console.log("Optional MCP add: codex mcp add infinite-canvas -- npm exec --yes --package=@pxxqc2t7bp-arch/canvas-agent@0.7.1 -- canvas-agent mcp --agent codex --name Codex");
